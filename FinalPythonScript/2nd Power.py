...
for p in range(2,4,2):
    print(p)
    E=[]
    potential=lambda E:RungeKutta(-6,0,.01,.01,6,lambda t,y,z:z,lambda t,y,z:(y*1*(E-V(t,p)))/c)[2][-1] #intervals of [a,b] where f(a)*f(b)<0
    print(potential(0))
    Intervals=selector(.01,.01,12,potential)
    #print(Intervals)s
    index=0
